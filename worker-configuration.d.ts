/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 53fb43767ca4703e037dedf7d0152483)
// Runtime types generated with workerd@1.20260611.1 2026-05-25 nodejs_compat
export {};
declare global {
	const SOCKS5_PROXY_HOSTNAME: string;
	const SOCKS5_PROXY_PORT: string;
	const SOCKS5_PROXY_USERNAME: string;
	const SOCKS5_PROXY_PASSWORD: string;
}
